...
@Injectable()
export class ProductionCompletionPostingRule implements PostingRule<ProductionOrderEntity> {
  constructor(
    @InjectRepository(ProductionOrderEntity)
    private readonly sourceRepository: Repository<ProductionOrderEntity>,
  ...
  async build(
    ...
    const finishedGoods = this.requireAccount(
    ...
    const amount = this.round(Number(source.actualTotalCost));
    ...
    return {
      ...
      referenceNumber: String(source.orderNumber),
      narration: 'Finished goods production completion',
      ...
      lines: [
        ...
        },
        {
          ...
          debit: 0,
          credit: amount,
          description: 'Work in progress transferred to finished goods',
          partyType: null,
          partyId: null,
          costCenter: null,
        },
