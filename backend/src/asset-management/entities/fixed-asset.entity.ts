...
@Index('UQ_fixed_assets_company_number', ['companyId', 'assetNumber'], {
  unique: true,
...
export class FixedAssetEntity {
  ...
  @Column({ name: 'asset_number', type: 'varchar', length: 40 })
  assetNumber!: string;
  ...
  @Column({ name: 'location', type: 'varchar', length: 180, nullable: true })
  location!: string | null;
  @Column({ name: 'custodian', type: 'varchar', length: 180, nullable: true })
