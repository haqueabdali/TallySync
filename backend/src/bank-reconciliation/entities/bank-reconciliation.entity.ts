...
@Index('IDX_bank_reconciliations_account_period', [
  'companyId',
  'bankAccountId',
  'statementStartDate',
  'statementEndDate',
...
@Index(
  'UQ_bank_reconciliations_company_reference',
  ['companyId', 'statementReference'],
...
export class BankReconciliationEntity {
  ...
  @Column({ name: 'statement_reference', type: 'varchar', length: 120 })
  ...
  @OneToMany(() => BankStatementLineEntity, (line) => line.reconciliation, {
    cascade: ['insert'],
    eager: true,
  })
