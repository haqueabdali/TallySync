...
export class CreateSupplierPayments1785800000000 implements MigrationInterface {
  name = 'CreateSupplierPayments1785800000000';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      ...
      BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_type
          WHERE typname = 'supplier_payments_method_enum'
        ) THEN
          CREATE TYPE "public"."supplier_payments_method_enum"
          AS ENUM (
            'Cash',
            'BankTransfer',
            'Card',
    ...
    await queryRunner.query(`
      CREATE TABLE IF NOT EXISTS "supplier_payments" (
        ...
        "payment_method" "public"."supplier_payments_method_enum"
          NOT NULL,
        ...
        CONSTRAINT "CHK_supplier_payments_amount"
          CHECK ("amount" > 0),
        CONSTRAINT "CHK_supplier_payments_allocated"
          CHECK (
            "allocated_amount" >= 0
            AND "allocated_amount" <= "amount"
          ),
        CONSTRAINT "CHK_supplier_payments_unallocated"
          CHECK (
            "unallocated_amount" >= 0
            AND "unallocated_amount" <= "amount"
          ),
        CONSTRAINT "CHK_supplier_payments_total_allocation"
          CHECK (
    ...
    await queryRunner.query(`
      CREATE TABLE IF NOT EXISTS "supplier_payment_allocations" (
        ...
        CONSTRAINT "PK_supplier_payment_allocations"
          PRIMARY KEY ("id"),
        CONSTRAINT "CHK_supplier_payment_allocations_amount"
    ...
    await queryRunner.query(`
      ...
      ON "supplier_payments" ("company_id")
    `);
    ...
    await queryRunner.query(`
      ...
      ON "supplier_payments" ("company_id", "status")
    `);

    await queryRunner.query(`
      CREATE UNIQUE INDEX IF NOT EXISTS
        "UQ_supplier_payments_company_number"
      ON "supplier_payments" ("company_id", "payment_number")
      WHERE "deleted_at" IS NULL
    `);

    await queryRunner.query(`
      CREATE INDEX IF NOT EXISTS
        "IDX_supplier_payment_allocations_payment"
      ON "supplier_payment_allocations" ("supplier_payment_id")
    `);

    await queryRunner.query(`
      CREATE INDEX IF NOT EXISTS
        "IDX_supplier_payment_allocations_invoice"
    ...
    await queryRunner.query(`
      ...
      BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint
          WHERE conname = 'FK_supplier_payments_supplier'
        ) THEN
    ...
    await queryRunner.query(`
      ...
      BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint
          WHERE conname = 'FK_supplier_payment_allocations_payment'
        ) THEN
    ...
    await queryRunner.query(`
      ...
      BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint
          WHERE conname = 'FK_supplier_payment_allocations_invoice'
        ) THEN
          ALTER TABLE "supplier_payment_allocations"
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      ALTER TABLE IF EXISTS "supplier_payment_allocations"
      DROP CONSTRAINT IF EXISTS
        "FK_supplier_payment_allocations_invoice"
    `);

    await queryRunner.query(`
      ALTER TABLE IF EXISTS "supplier_payment_allocations"
      DROP CONSTRAINT IF EXISTS
        "FK_supplier_payment_allocations_payment"
    `);

    await queryRunner.query(`
      ALTER TABLE IF EXISTS "supplier_payments"
      DROP CONSTRAINT IF EXISTS "FK_supplier_payments_supplier"
    `);
    ...
    await queryRunner.query(`
      DROP TYPE IF EXISTS
        "public"."supplier_payments_method_enum"
    `);

    await queryRunner.query(`
      DROP TYPE IF EXISTS
        "public"."supplier_payments_status_enum"
    `);
  }
}
