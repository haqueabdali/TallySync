...
export class CreateManualCostAdjustmentLineDto {
  ...
  @ApiProperty({ enum: ManualCostAdjustmentType })
  @IsEnum(ManualCostAdjustmentType)
  adjustmentType!: ManualCostAdjustmentType;
  @ApiPropertyOptional({
    description: 'Required for quantity adjustments.',
    minimum: 0.0001,
  })
  @IsOptional()
  @Type(() => Number)
  ...
  quantity?: number;
  @ApiPropertyOptional({
    description: 'Required only for quantity increases.',
    minimum: 0,
  })
  @IsOptional()
  @Type(() => Number)
  ...
  unitCost?: number;
  @ApiPropertyOptional({
    description: 'Required for value-only adjustments.',
    minimum: 0.0001,
  })
  @IsOptional()
  @Type(() => Number)
...
export class CreateManualCostAdjustmentDto {
  ...
  @Length(1, 1000)
  notes?: string;
  @ApiProperty({ type: [CreateManualCostAdjustmentLineDto] })
  @IsArray()
  @ArrayMinSize(1)
  @ValidateNested({ each: true })
  @Type(() => CreateManualCostAdjustmentLineDto)
  lines!: CreateManualCostAdjustmentLineDto[];
}
