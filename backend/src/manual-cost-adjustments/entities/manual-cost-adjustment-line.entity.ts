...
export class ManualCostAdjustmentLineEntity {
  ...
  @Column({
    ...
    type: 'enum',
    enum: ManualCostAdjustmentType,
    enumName: 'manual_cost_adjustment_type_enum',
  })
  ...
  newValue!: number;
  @Column({
    name: 'old_average_unit_cost',
    type: 'numeric',
    precision: 18,
    scale: 6,
    transformer: numberTransformer,
  })
  oldAverageUnitCost!: number;
  @Column({
    name: 'new_average_unit_cost',
    type: 'numeric',
    precision: 18,
    scale: 6,
    transformer: numberTransformer,
