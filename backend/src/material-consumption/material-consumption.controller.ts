...
export class MaterialConsumptionController {
  ...
  create(@Req() request: AuthenticatedRequest, @Body() dto: CreateMaterialConsumptionDto) {
  ...
  findAll(@Req() request: AuthenticatedRequest, @Query() filter: MaterialConsumptionFilterDto) {
