...
import { ProductionVarianceController } from './production-variance.controller';
...
@Module({
  ...
  controllers: [ProductionVarianceController],

  providers: [ProductionVarianceService],

  exports: [ProductionVarianceService],
})
