...
export class SupplierEntity {
  ...
  @Column({ name: 'supplier_code', type: 'varchar', length: 30 })
  supplierCode!: string;
  ...
  @Column({ type: 'varchar', length: 180, nullable: true }) email!:
    string | null;
  @Column({ type: 'varchar', length: 40, nullable: true }) phone!:
    string | null;
  @Column({ type: 'varchar', length: 40, nullable: true }) mobile!:
    string | null;
  @Column({ name: 'tax_number', type: 'varchar', length: 80, nullable: true })
  taxNumber!: string | null;
  @Column({ name: 'vat_number', type: 'varchar', length: 80, nullable: true })
  ...
  @Column({ name: 'payment_terms', type: 'integer', default: 0 })
  paymentTerms!: number;
