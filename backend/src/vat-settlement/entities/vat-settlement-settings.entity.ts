...
export class VatSettlementSettingsEntity {
  ...
  @Column({ name: 'output_vat_account_id', type: 'uuid' })
  outputVatAccountId!: string;
  @Column({ name: 'input_vat_account_id', type: 'uuid' })
  inputVatAccountId!: string;
  @Column({ name: 'vat_payable_account_id', type: 'uuid' })
  vatPayableAccountId!: string;
  @Column({ name: 'vat_receivable_account_id', type: 'uuid' })
